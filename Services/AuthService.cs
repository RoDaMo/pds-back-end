...
public class AuthService
{
	...
	public async Task<User> GetUserByIdAsync(Guid userId) 
		=> await _dbService.GetAsync<User>("SELECT Id, Name, Username, Email, Deleted, Birthday, cpf, bio, picture, championshipId, teammanagementid, playerteamid, role FROM users WHERE id = @Id AND deleted = false", new User { Id = userId });
