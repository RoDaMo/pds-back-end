...
public class TeamService
{
    ...
    private async Task<int> CreateSendAsync(Team team) => await _dbService.EditData(
			"INSERT INTO teams (emblem, uniformHome, uniformAway, deleted, sportsid, name, numberofplayers) VALUES (@Emblem, @UniformHome, @UniformWay, @Deleted, @SportsId, @Name, 0) RETURNING Id;",
			team);
